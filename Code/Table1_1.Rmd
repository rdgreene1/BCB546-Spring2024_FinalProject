...
ggplot(data, aes(x = Element, y = log_p_value, fill = Variant)) + 
  geom_bar(stat = "identity", position = position_dodge(width = 0.9), width = 0.8) +  # Increased bar width for better visibility
  ...
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),  # Adjusted label alignment for better legibility
